            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-md-6">
                        ...
                        <span id="applicant-first-name"><?php echo $application->first_name ?></span>
                    </div>
                    <div class="col-md-6">
                        <label>Last Name:</label>
                        <span id="applicant-last-name"><?php echo $application->last_name ?></span>
                    </div>

                    <div class="col-md-6">
                        <label>Other Names:</label>
                        <span id="applicant-other-name"><?php echo $application->other_names ?></span>
                    </div>
    ...
    <script>
        $('#download_btn').on('click', function () {
            var document_name = $('#applicant-last-name').text() + ' '+
                $('#applicant-first-name').text() + ' Application.pdf';
            var doc = new jsPDF();
            var content = document.querySelector('#enrollment_details_content');
            doc.fromHTML(
                content,
                15,
                15,
                {},
                function (bla) { doc.save(document_name); },
            0);
        });
